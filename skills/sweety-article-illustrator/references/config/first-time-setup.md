...
description: First-time setup flow for sweety-article-illustrator preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.sweety-skills/sweety-article-illustrator/EXTEND.md` | Current project |
| User | `~/.sweety-skills/sweety-article-illustrator/EXTEND.md` | All projects |
