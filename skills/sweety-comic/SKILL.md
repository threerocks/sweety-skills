...
metadata:
  openclaw:
    homepage: https://github.com/sweety/sweety-skills#sweety-comic
    requires:
      anyBins:
        - bun
        - npx
...
/sweety-comic article.md --art manga --tone warm
/sweety-comic  # then paste content
```
...
- Invoke an installed image generation skill such as `sweety-image-gen`
