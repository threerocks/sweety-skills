...
description: First-time setup flow for sweety-comic preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.sweety-skills/sweety-comic/EXTEND.md` | Current project |
| User | `~/.sweety-skills/sweety-comic/EXTEND.md` | All projects |
