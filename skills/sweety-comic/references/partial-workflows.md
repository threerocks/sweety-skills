...
```bash
/sweety-comic content.md --storyboard-only
```
...
```bash
/sweety-comic content.md --prompts-only
```
...
```bash
/sweety-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/sweety-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/sweety-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/sweety-comic comic/topic-slug/ --regenerate 0
```
