...
test -f .sweety-skills/sweety-comic/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/sweety-skills/sweety-comic/EXTEND.md" && echo "xdg"
test -f "$HOME/.sweety-skills/sweety-comic/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .sweety-skills/sweety-comic/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/sweety-skills/sweety-comic/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.sweety-skills/sweety-comic/EXTEND.md") { "user" }
```

| Path | Location |
|------|----------|
| `.sweety-skills/sweety-comic/EXTEND.md` | Project directory |
| `$HOME/.sweety-skills/sweety-comic/EXTEND.md` | User home |
...
**Strategy A: Using `--ref` parameter** (e.g., sweety-image-gen)
