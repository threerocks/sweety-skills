...
metadata:
  openclaw:
    homepage: https://github.com/sweety/sweety-skills#sweety-danger-gemini-web
    requires:
      anyBins:
        - bun
        - npx
...
- macOS: `~/Library/Application Support/sweety-skills/gemini-web/consent.json`
- Linux: `~/.local/share/sweety-skills/gemini-web/consent.json`
- Windows: `%APPDATA%\sweety-skills\gemini-web\consent.json`
...
test -f .sweety-skills/sweety-danger-gemini-web/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/sweety-skills/sweety-danger-gemini-web/EXTEND.md" && echo "xdg"
test -f "$HOME/.sweety-skills/sweety-danger-gemini-web/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .sweety-skills/sweety-danger-gemini-web/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/sweety-skills/sweety-danger-gemini-web/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.sweety-skills/sweety-danger-gemini-web/EXTEND.md") { "user" }
```

┌──────────────────────────────────────────────────────────┬───────────────────┐
│                           Path                           │     Location      │
├──────────────────────────────────────────────────────────┼───────────────────┤
│ .sweety-skills/sweety-danger-gemini-web/EXTEND.md          │ Project directory │
├──────────────────────────────────────────────────────────┼───────────────────┤
│ $HOME/.sweety-skills/sweety-danger-gemini-web/EXTEND.md    │ User home         │
└──────────────────────────────────────────────────────────┴───────────────────┘
