...
description: First-time setup flow for sweety-danger-x-to-markdown preferences
---
...
options:
  - label: "User (Recommended)"
    description: "~/.sweety-skills/ (all projects)"
  - label: "Project"
    description: ".sweety-skills/ (this project only)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.sweety-skills/sweety-danger-x-to-markdown/EXTEND.md` | All projects |
| Project | `.sweety-skills/sweety-danger-x-to-markdown/EXTEND.md` | Current project |
