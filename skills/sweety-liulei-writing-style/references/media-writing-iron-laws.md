...
1. 真实案例或故事剧本：一个人、一个时间点、一个场景、一个选择、一个代价；若不能直接使用真实人物，先写有来源边界的虚拟人物剧本。
...
```json
{
  ...
  "story_blueprint": {
    "prototype_sources": ["公开案例、政策问答、法院案例、学校就业指导、招聘场景、评论/论坛归纳等"],
    "fictional_role": "虚拟人物身份",
    "opening_scene": "故事第一幕",
    "wrong_choice": "人物的错误选择",
    "cost": "代价或后果",
    "turning_action": "后续正确动作",
    "boundary": "哪些信息是合成、匿名或不得写死"
  },
  "action_cards": [
    {
      "who": "适用对象",
...
可以把真实案例改写成虚拟人物，也可以在公开材料不足以直接成文时先写故事剧本，但不能凭空编故事。
...
- 学校就业指导、招聘会、官方平台岗位说明或多条可核验普通人困境的归纳。
...
- 在资料包里记录 `story_blueprint`：原型来源、虚拟人物、开场场景、错误选择、代价、转折动作和虚构处理边界。
- 正文不得交代写作后台，不写“这是虚拟人物”“不是投稿”“故事线来自”“我写他是因为”等制作说明。取材来源和合成边界放在资料包、门禁报告或审稿清单里；正文只呈现典型场景和可执行动作。
- 正文不得伪装为真实投稿、粉丝私信、作者亲历或采访；如果不是纪实采访，就不要使用“有读者问我”“他告诉我”“我采访到”等来源话术。
...
- `12333` 必须落到拨打 12333 电话、掌上12333 App/小程序、电子社保卡、国家社会保险公共服务平台、全国人社政务服务平台、本地人社 App 或窗口。
- 现金流必须落到手机银行 App/网银、微信/支付宝余额、信用卡账单、还款日、工资卡流水等字段。
- 禁止“打开 12333”“打开银行卡”“看银行卡”这种让读者不知道点哪里的表达。
