...
const FALLBACK_THEMES: ThemeName[] = ["default", "grace", "simple", "modern", "juejin", "github", "typewriter", "ink", "chinese-red", "minimalist", "warm", "tech-blue", "wechat-elegant", "condensed"];
const THEMES_EXTENDING_DEFAULT = new Set<ThemeName>(["grace", "simple", "juejin", "github", "typewriter", "ink", "chinese-red", "minimalist", "warm", "tech-blue", "wechat-elegant", "condensed"]);
