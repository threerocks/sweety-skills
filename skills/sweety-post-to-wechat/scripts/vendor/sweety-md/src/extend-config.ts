...
export function loadExtendConfig(): Partial<ExtendConfig> {
  const paths = [
    path.join(process.cwd(), ".sweety-skills", "sweety-markdown-to-html", "EXTEND.md"),
    path.join(
      process.env.XDG_CONFIG_HOME || path.join(homedir(), ".config"),
      "sweety-skills", "sweety-markdown-to-html", "EXTEND.md"
    ),
    path.join(homedir(), ".sweety-skills", "sweety-markdown-to-html", "EXTEND.md"),
  ];
