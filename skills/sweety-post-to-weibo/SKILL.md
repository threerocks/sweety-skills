...
metadata:
  openclaw:
    homepage: https://github.com/sweety/sweety-skills#sweety-post-to-weibo
    requires:
      anyBins:
        - bun
        - npx
...
test -f .sweety-skills/sweety-post-to-weibo/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/sweety-skills/sweety-post-to-weibo/EXTEND.md" && echo "xdg"
test -f "$HOME/.sweety-skills/sweety-post-to-weibo/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .sweety-skills/sweety-post-to-weibo/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/sweety-skills/sweety-post-to-weibo/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.sweety-skills/sweety-post-to-weibo/EXTEND.md") { "user" }
```

┌──────────────────────────────────────────────────┬───────────────────┐
│                       Path                       │     Location      │
├──────────────────────────────────────────────────┼───────────────────┤
│ .sweety-skills/sweety-post-to-weibo/EXTEND.md      │ Project directory │
├──────────────────────────────────────────────────┼───────────────────┤
│ $HOME/.sweety-skills/sweety-post-to-weibo/EXTEND.md│ User home         │
└──────────────────────────────────────────────────┴───────────────────┘
