...
metadata:
  openclaw:
    homepage: https://github.com/sweety/sweety-skills#sweety-slide-deck
    requires:
      anyBins:
        - bun
        - npx
...
```bash
/sweety-slide-deck path/to/content.md
/sweety-slide-deck path/to/content.md --style sketch-notes
/sweety-slide-deck path/to/content.md --audience executives
/sweety-slide-deck path/to/content.md --lang zh
/sweety-slide-deck path/to/content.md --slides 10
/sweety-slide-deck path/to/content.md --outline-only
/sweety-slide-deck  # Then paste content
```
...
test -f .sweety-skills/sweety-slide-deck/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/sweety-skills/sweety-slide-deck/EXTEND.md" && echo "xdg"
test -f "$HOME/.sweety-skills/sweety-slide-deck/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .sweety-skills/sweety-slide-deck/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/sweety-skills/sweety-slide-deck/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.sweety-skills/sweety-slide-deck/EXTEND.md") { "user" }
```

┌──────────────────────────────────────────────────┬───────────────────┐
│                       Path                       │     Location      │
├──────────────────────────────────────────────────┼───────────────────┤
│ .sweety-skills/sweety-slide-deck/EXTEND.md         │ Project directory │
├──────────────────────────────────────────────────┼───────────────────┤
│ $HOME/.sweety-skills/sweety-slide-deck/EXTEND.md   │ User home         │
└──────────────────────────────────────────────────┴───────────────────┘
...
```bash
/sweety-slide-deck content.md --prompts-only
```
...
```bash
/sweety-slide-deck slide-deck/topic-slug/ --images-only
```
...
```bash
# Single slide
/sweety-slide-deck slide-deck/topic-slug/ --regenerate 3

# Multiple slides
/sweety-slide-deck slide-deck/topic-slug/ --regenerate 2,5,8
```
...
2. Run: `/sweety-slide-deck <dir> --regenerate N`
