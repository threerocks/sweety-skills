...
Structure for user preferences in `.sweety-skills/sweety-slide-deck/EXTEND.md`.
...
Then use with: `/sweety-slide-deck content.md --style style-name`
...
1. `.sweety-skills/sweety-slide-deck/EXTEND.md` (project)
2. `$HOME/.sweety-skills/sweety-slide-deck/EXTEND.md` (user)
