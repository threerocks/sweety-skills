...
description: First-time setup flow for sweety-translate preferences
---
...
options:
  - label: "User (Recommended)"
    description: "$HOME/.sweety-skills/ (all projects)"
  - label: "Project"
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `$HOME/.sweety-skills/sweety-translate/EXTEND.md` | All projects |
| Project | `.sweety-skills/sweety-translate/EXTEND.md` | Current project |
