...
description: First-time setup flow for sweety-url-to-markdown preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.sweety-skills/sweety-url-to-markdown/EXTEND.md` | All projects |
| Project | `.sweety-skills/sweety-url-to-markdown/EXTEND.md` | Current project |
