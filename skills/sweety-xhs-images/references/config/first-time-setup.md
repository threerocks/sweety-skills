...
description: First-time setup flow for sweety-xhs-images preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.sweety-skills/sweety-xhs-images/EXTEND.md` | Current project |
| User | `~/.sweety-skills/sweety-xhs-images/EXTEND.md` | All projects |
